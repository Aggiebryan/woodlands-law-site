      ...
      <div className="flex items-center justify-center mb-10 px-4">
        {steps.map((s, i) => (
          <div key={s.num} className="flex items-center">
            ...
            {i < steps.length - 1 && (
              <div className="w-12 h-px bg-muted-foreground/20 mx-3" />
            )}
          </div>
        ))}
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="bg-background border border-border rounded p-8 md:p-10 animate-in fade-in slide-in-from-bottom-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <FormField control={form.control} name="firstName" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">First Name <span className="text-law-gold">*</span></FormLabel>
                ...
                <FormField control={form.control} name="lastName" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Last Name <span className="text-law-gold">*</span></FormLabel>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <FormField control={form.control} name="phone" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Phone Number <span className="text-law-gold">*</span></FormLabel>
                ...
                <FormField control={form.control} name="email" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Email Address</FormLabel>
              ...
              <FormField control={form.control} name="preferredContact" render={({ field }) => (
                <FormItem className="mb-5">
                  <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Preferred Contact Method</FormLabel>
                  <FormControl>
                    <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex gap-2 mt-1">
                      {["phone", "email", "text"].map((m) => (
                        <label key={m} className={`inline-flex items-center px-4 py-2 border rounded-sm text-xs uppercase tracking-wider font-medium cursor-pointer transition-all ${
                          field.value === m
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <FormField control={form.control} name="language" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Language Preference</FormLabel>
                ...
                <FormField control={form.control} name="referralSource" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">How Did You Hear About Us?</FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
          ...
          {step === 2 && (
            <div className="bg-background border border-border rounded p-8 md:p-10 animate-in fade-in slide-in-from-bottom-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <FormField control={form.control} name="matterType" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Type of Matter <span className="text-law-gold">*</span></FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl><SelectTrigger><SelectValue placeholder="— Select —" /></SelectTrigger></FormControl>
                      <SelectContent>
                ...
                <FormField control={form.control} name="county" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">County</FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl><SelectTrigger><SelectValue placeholder="— Select —" /></SelectTrigger></FormControl>
                      <SelectContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <FormField control={form.control} name="incidentDate" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Date of Incident / Issue</FormLabel>
                    <FormControl><Input type="date" {...field} /></FormControl>
                  </FormItem>
                )} />
                <FormField control={form.control} name="companyName" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Business / Company Involved</FormLabel>
                    <FormControl><Input placeholder="e.g., ABC Insurance Co." {...field} /></FormControl>
                  </FormItem>
                )} />
              </div>

              <FormField control={form.control} name="opposingParties" render={({ field }) => (
                <FormItem className="mb-5">
                  <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Opposing Party / Defendant</FormLabel>
                  <FormControl><Input placeholder="Name of person, business, or insurer" {...field} /></FormControl>
              ...
              <FormField control={form.control} name="summaryOfIssue" render={({ field }) => (
                <FormItem className="mb-5">
                  <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Summary of Your Matter <span className="text-law-gold">*</span></FormLabel>
                  <FormControl><Textarea className="min-h-[110px]" placeholder="Describe what happened, what the other party did or failed to do, and what outcome you are seeking…" {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />

              <FormField control={form.control} name="damagesDescription" render={({ field }) => (
                <FormItem className="mb-5">
                  <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Damages / Losses</FormLabel>
                  <FormControl><Textarea className="min-h-[88px]" placeholder="Describe any financial losses, property damage, personal injuries, or other harm…" {...field} /></FormControl>
                </FormItem>
              )} />
              ...
              <FormField control={form.control} name="urgencyLevel" render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Urgency Level <span className="text-law-gold">*</span></FormLabel>
                  <FormControl>
                    <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex flex-wrap gap-2 mt-1">
                      {urgencyOptions.map((opt) => (
                        <label key={opt.value} className={`inline-flex items-center px-4 py-2 border rounded-sm text-xs uppercase tracking-wider font-medium cursor-pointer transition-all ${
                          field.value === opt.value ? opt.color : "border-border text-muted-foreground hover:border-foreground/30"
                        }`}>
              ...
              <div className="flex justify-between mt-9 pt-7 border-t border-border">
                ...
                <Button type="button" className="btn-gold-metallic px-8" onClick={() => validateAndNext(3)}>Review →</Button>
              </div>
            </div>
          )}
            ...
            <div className="bg-background border border-border rounded p-8 md:p-10 animate-in fade-in slide-in-from-bottom-2">
              ...
              <div className="bg-law-gold/5 border border-law-gold/25 border-l-[3px] border-l-law-gold rounded-sm p-4 mb-7 text-xs text-muted-foreground leading-relaxed">
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    <strong className="text-foreground font-medium">Confidentiality Notice.</strong> The information you submit is protected by attorney-client privilege to the extent permitted by Texas law. Submission does not create an attorney-client relationship, but all information will be treated as confidential.
                  </p>
                </div>
              </div>
              ...
              <div className="text-sm mb-7">
                {[
                  ...
                  <div key={label} className="grid grid-cols-[160px_1fr] gap-2 py-2 border-b border-border">
                    <span className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium pt-0.5">{label}</span>
              ...
              <div className="flex justify-between mt-9 pt-7 border-t border-border">
                <Button type="button" variant="outline" onClick={() => setStep(2)}>← Edit</Button>
