        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4 mb-4">
              ...
              <a href="https://www.instagram.com/woodlandslaw/" className="text-white hover:text-law-gold transition-colors">
                <Instagram size={20} />
              </a>
              <a href="https://linkedin.com/company/woodlandslaw" className="text-white hover:text-law-gold transition-colors">
                <Linkedin size={20} />
              </a>
            </div>
        ...
        <div className="border-t border-white/10 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              ...
              <span className="opacity-70">|</span>
              <Link to="/terms-of-service" className="text-sm opacity-70 hover:opacity-100 hover:text-law-gold transition-colors">
                Terms of Service
              </Link>
              <span className="opacity-70">|</span>
              <Link 
