      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-white/80 text-lg md:text-xl mb-10 max-w-2xl">
            Comprehensive advocacy for complex disputes and future planning—personalized service devoted to securing
            justice and preserving your legacy.
          </p>

          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/schedule" className="btn-gold-metallic py-3 px-8 rounded inline-block text-center">
